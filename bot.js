...
c.v-يسولك رماة صوتية من عنده 
c.t - يسولك رماة كتابية من عنده 
c.role-يسولك رتب من عنده 
-c.roles يسولك رتب حلوة 
-c.romes يسوللك رماة كتبية وصوتية 
enjoy :heart:
`)
   message.author.sendEmbed(embed)
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=485192580800315403&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add mineplex3rb ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("485191454696931328").sendEmbed(embed)
});
...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '409093271592370186') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '409093271592370186') return;
...
client.users.get("409093271592370186","406066481613373450").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => { 
    ...
    .setFooter(`mineplex3rb`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/jYY5tF")
